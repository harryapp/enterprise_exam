package no.kristiania.enterprise_exam.security

import no.kristiania.enterprise_exam.security.filter.CustomAuthenticationFilter
import no.kristiania.enterprise_exam.security.filter.CustomAuthorizationFilter
...
class SecurityConfig(
    ...
    override fun configure(http: HttpSecurity) {
        ...
        http.authorizeRequests()
            ...
            .antMatchers("/api/delivery/**").hasAnyAuthority("USER", "ADMIN")
